...
The system SHALL preserve the current user-facing behavior for initialization, schema output, weight add/list/update/delete, comparison, and diet advice commands.
